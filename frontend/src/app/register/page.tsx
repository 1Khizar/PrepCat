...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.phone || !formData.password) {
      setError("Please fill in all fields to begin your journey.");
      return;
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-amazing-gradient relative overflow-hidden">
      ...
      <div className="w-full max-w-xl">
        <div className="amazing-card !p-8 md:!p-12 bg-white">
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <h1 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Create Your Account</h1>
              <p className="text-slate-500 font-medium text-sm">Join the smartest medical preparation platform in Pakistan.</p>
            </div>

            {/* Form Fields: Cleaner Alignment */}
            <div className="grid gap-5">
              <div className="space-y-2">
                <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest pl-1">Full Name</label>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest pl-1">Email Address</label>
                <div className="relative">
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div className="space-y-2">
                  <label className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest pl-1">Phone</label>
                  <div className="relative">
            ...
            <div className="space-y-6 pt-2">
              ...
              <p className="text-center text-xs font-medium text-slate-500">
                Already have an account? <Link href="/login" className="text-brand-primary font-semibold hover:underline underline-offset-4">Sign In</Link>
              </p>
            </div>
          </form>
        </div>
        ...
        <div className="mt-8 flex justify-center items-center gap-6 text-[10px] font-medium text-slate-400 uppercase tracking-widest text-center">
          ...
          <div>Trusted by 25k+ MDCAT Aspirants 🇵🇰</div>
        </div>
      </div>
    </div>
  );
